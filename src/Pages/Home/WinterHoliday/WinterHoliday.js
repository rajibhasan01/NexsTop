        ...
        <div className="container my-5 pb-md-5">
            <div className="d-flex justify-content-center">
                <div className="text-center">
                    <h2 className="google-font text-warning">Enjoy Your</h2>
                    <h1 className="text-size fw-bold">Winter Holiday</h1>
                    <p className="text-muted">Font is very essential for presentation any kinds of readable topics to the reader. Stylish google font has made the way easy to the presenter. Our latest theme was created for sharing the finer things in life. </p>
                </div>
