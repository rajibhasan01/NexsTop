    ...
    return (
        <Col>
            <Card className="border-0 p-0 text-start card-container mb-4">
                ...
                <Card.Text className="text-white img-text-bg py-2 text-center">{date} <span> - </span> <span className="text-background text-white pe-3"><MdIconName.MdPlace /> {blog.type} </span> - <span className="text-white">Skiing</span></Card.Text>
